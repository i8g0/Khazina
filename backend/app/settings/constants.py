...
NOTIFICATION_KIND_RISK_AI_RECOMMENDATIONS_COMPLETED = "risk_ai_recommendations_completed"
NOTIFICATION_KIND_RISK_ANALYSIS_COMPLETED = "risk_analysis_completed"
NOTIFICATION_KIND_RISK_ANALYSIS_FAILED = "risk_analysis_failed"
...
DEFAULT_ENABLED_NOTIFICATION_KINDS: frozenset[str] = frozenset(
    {
        ...
        NOTIFICATION_KIND_RISK_AI_RECOMMENDATIONS_COMPLETED,
        NOTIFICATION_KIND_RISK_ANALYSIS_COMPLETED,
        NOTIFICATION_KIND_RISK_ANALYSIS_FAILED,
